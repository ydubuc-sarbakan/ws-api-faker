...
export class ArcadeController {
    ...
    async handlePlayerFinishedRaceClientRequest(request: PlayerFinishedRaceClientRequest, socket: WebSocket): Promise<void> {
    ...
    async handlePlayerFinishedCupClientRequest(request: PlayerFinishedCupClientRequest, socket: WebSocket): Promise<void> {
